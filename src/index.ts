...
// values.subscribe(x => console.log('values is ' + x));
...
// const connectStream = combineLatest([streamOfNumbers, singleOutput]).pipe(
//     map(([stream, singleOut]) => {
//         return (`${singleOut}`);
//     }),
//     connectStream.subscribe(([val]) => console.log(val))));
